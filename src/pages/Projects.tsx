...
const Projects: React.FC = () => {
  ...
  return (
    <div className="py-5 lg:py-8 bg-white min-h-screen">
      ...
      {/* Controls Bar */}
      <section className="pb-8 bg-white border-b border-gray-100 sticky top-20 z-40">
                ...
                >
                  ...
                  <div className="lg:w-3/5 p-10 flex flex-col gap-6">
                    <div className="space-y-4">
                      ...
                      <h3 className="text-3xl font-black text-blue-950 leading-tight group-hover:text-emerald-600 transition-colors">
                        {project.title}
                      </h3>
