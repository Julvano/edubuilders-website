...
export interface Content {
  ...
  donate: {
    ...
    recapTitle: string;
    recapPaiement: string;
    recapAmount: string;
    recapAnonymous: string;
    recapDonnator: string;
  };
  contact: {
    title: string;
    subtitle: string;
...
export const translations: Record<Language, Content> = {
  fr: {
    ...
    donate: {
      ...
      recapSubtitle: "Don Enregistré",
      recapTitle: "Récapitulatif",
      recapPaiement: "Paiement Sécurisé",
      recapAmount: "Montant",
      recapAnonymous: "Anonyme",
      recapDonnator: "Donateur"
    },
    contact: {
      ...
      thankYouTitle: "Message Bien Reçu !",
      thankYouMessage: "Merci pour votre démarche ! Nous accusons bonne réception de votre demande d'informations ou proposition. Une notification de confirmation récapitulative a été générée.",
      newContact: "Envoyer un autre message",
      recapTitle: "Détails de l'envoi",
      recapSubject: "Objet"
    },
    publications: {
    ...
    footer: {
      ...
      newsletter: "Restez informé de nos dernières innovations pédagogiques."
    },
    loader: {
  ...
  en: {
    ...
    donate: {
      ...
      recapSubtitle: "Donation Received",
      recapTitle: "Summary",
      recapPaiement: "Secure Payment",
      recapAmount: "Amount",
      recapAnonymous: "Anonymous",
      recapDonnator: "Donor"
    },
    contact: {
      title: "Contact Us",
      ...
      thankYouMessage: "Thank you for getting in touch! We acknowledge receipt of your message. A confirmation notification has been successfully generated.",
      newContact: "Send another message",
      recapTitle: "Sent Details",
    ...
    footer: {
      ...
      newsletter: "Stay informed about our latest pedagogical innovations."
    },
    loader: {
