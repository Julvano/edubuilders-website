...
const Navbar: React.FC = () => {
  ...
  // Ordre corrigé : Les autres items après "Accueil" et "À propos"
  const navItems = [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <NavLink to={langPath('/')} className="flex flex-col">
            ...
            <span className="text-[10px] uppercase font-semibold text-gray-500 tracking-wider hidden sm:block">
              ...
              <img 
                ...
                className="h-12 w-auto sm:h-16 md:h-15 lg:h-18 object-contain"
              />
          </NavLink>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            {/* 3. AUTRES ITEMS (Actions, Partners, Publications) */}
            {navItems.map((item) => (
              <NavLink
                key={item.path}
                to={langPath(item.path)}
