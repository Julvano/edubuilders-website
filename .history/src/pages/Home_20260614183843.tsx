  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto  relative z-10 py-5 ">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 space-y-2 text-center lg:text-left">
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-blue-950 leading-[1.1] tracking-tighter">
                  {content.hero.title}
                </h1>
      ...
      <section className="py-24 bg-white overflow-hidden border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           >
              ...
              <p className="text-2xl lg:text-3xl font-bold text-blue-950 leading-relaxed relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-end justify-between gap-6 mb-16">
            <div className="space-y-4">
              <h2 className="text-4xl lg:text-5xl font-black text-blue-950 uppercase tracking-tight">
