    ...
    <div className="py-5 lg:py-8 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24 space-y-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-blue-950 uppercase tracking-tighter">
            {t.title}
          </h1>
          ...
          <div className="space-y-12">
            <section className="bg-gray-50 p-10 rounded-[3rem] border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl sm:text-2xl md:text-2xl lg:text-2xl font-black text-blue-950 uppercase tracking-tight">{t.statutesTitle}</h2>
              </div>
