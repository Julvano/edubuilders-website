...
const Careers: React.FC = () => {
        ...
        <section className="space-y-12">
           {/* <div className="flex flex-col md:flex-row justify-between items-end gap-8 border-b border-gray-100 pb-12">
              <div className="space-y-4">
                 <h2 className="text-xl lg:text-3xl font-black text-blue-950 uppercase tracking-tight">{t.listingTitle}</h2>
  ...
  <div className="space-y-4 w-full">
    ...
    {/* Conteneur de boutons qui passent à la ligne automatiquement */}
  ...
  {/* Barre de recherche (prend toute la largeur sur mobile, fixe sur desktop) */}
