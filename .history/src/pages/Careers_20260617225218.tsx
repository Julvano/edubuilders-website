    ...
    <div className="py-5 lg:py-8 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mb-16 lg:mb-20 space-y-4">
           ...
           <p className="text-lg lg:text-xl text-gray-600 font-medium leading-relaxed break-words hyphens-auto text-justify">
             {t.intro}
           </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-32">
           <div className="space-y-12">
              <section className="space-y-6">
                 ...
                 <p className="text-lg text-gray-600 font-medium leading-relaxed break-words hyphens-auto text-justify">
                    {t.valuesText}
                 </p>
              ...
              <section className="space-y-6">
                 ...
                 <p className="text-lg text-gray-600 font-medium leading-relaxed break-words hyphens-auto text-justify italic border-l-4 border-emerald-100 pl-6">
                    {t.processText}
                 </p>
              </section>
           </div>
