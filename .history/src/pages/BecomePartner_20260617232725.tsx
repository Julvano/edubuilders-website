        ...
        <div className="bg-blue-950 p-16 lg:p-24 rounded-[5rem] text-white relative overflow-hidden">
           ...
           <div className="max-w-3xl relative z-10 space-y-12">
              <div className="space-y-6">
                 ...
                 <h2 className="text-xl lg:text-4xl font-black leading-tighter text-blue-100 uppercase tracking-tighter leading-tighter break-words hyphens-auto text-justify">
