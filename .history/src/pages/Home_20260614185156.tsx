      ...
      <section className="py-24 bg-white overflow-hidden border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           >
              ...
              <p className="text-xl lg:text-2xl font-bold text-blue-950 leading-relaxed relative z-10 text-justify">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-end justify-between gap-6 mb-16">
            <div className="space-y-4">
              <h2 className="text-xl lg:text-4xl font-black text-blue-950 uppercase tracking-tight">
            ...
            <Link 
              ...
              className="group flex items-center gap-3 text-md font-black text-blue-900 uppercase tracking-widest hover:text-emerald-600 transition-colors"
            >
