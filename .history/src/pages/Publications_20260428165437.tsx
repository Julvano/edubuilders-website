...
// ... (Mock Data ARTICLES et DOCUMENTS restent identiques)
...
const ArticleCard: React.FC<{ article: typeof ARTICLES[0], lang: 'fr' | 'en', t: any, langPath: (p: string) => string }> = ({ article, lang, t, langPath }) => (
  <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl transition-all duration-300 h-full flex flex-col">
    ...
    <div className="p-8 space-y-6 flex-grow flex flex-col">
      ...
      <h3 className="text-xl font-black text-blue-900 leading-tight group-hover:text-emerald-700 transition-colors">
        {article.title[lang]}
      </h3>
...
const Publications: React.FC = () => {
  ...
  // 1. État initial corrigé sur 'articles'
        ...
        <div className="space-y-12 mb-16">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            <div className="space-y-4">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-black text-blue-950 uppercase tracking-tighter leading-none">
                {t.publications.title}
              </h1>
              <div className="w-20 sm:w-24 h-1.5 bg-emerald-500 rounded-full" />
            </div>
          ...
          {/* 2. Onglets inversés : Articles en premier */}
        ...
        <div className="mt-16 pt-8 border-t border-gray-100">
           <p className="text-blue-900 font-bold">
             ...
             <span className="ml-2 uppercase text-xs tracking-widest text-gray-400">
               {activeTab === 'articles' ? 'opportunités identifiées' : 'documents disponibles'}
             </span>
           </p>
        </div>
      </div>
