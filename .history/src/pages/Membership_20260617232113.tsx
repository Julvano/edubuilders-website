    ...
    <div className="py-5 lg:py-8 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 lg:mb-20 space-y-4">
          ...
          <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto font-medium leading-tighter break-words hyphens-auto text-justify">
            {t.intro}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          >
             ...
             <div className="relative z-10 space-y-8 max-w-md">
                ...
                <h2 className="text-xl lg:text-3xl font-black text-white leading-tight uppercase tracking-tight">
                  {t.readyTitle}
                </h2>
                ...
                <a 
                  ...
                  className="inline-flex text-xl w-full bg-emerald-500 hover:bg-emerald-400 text-blue-950 font-black py-6 rounded-3xl transition-all uppercase tracking-widest shadow-2xl shadow-emerald-500/30 items-center justify-center gap-3 group px-8"
                >
