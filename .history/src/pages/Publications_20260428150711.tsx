        ...
        <div className="space-y-12 mb-16">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            <div className="space-y-4">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-3xl font-black text-blue-950 uppercase tracking-tighter leading-none">
        ...
        <div className="mt-16 pt-8 border-t border-gray-100">
           <p className="text-blue-900 font-bold">
             <span className="text-3xl tracking-tighter">
               {activeTab === 'documents' ? DOCUMENTS.length : ARTICLES.length}
             </span>
             <span className="ml-2 uppercase text-xs tracking-widest text-gray-400">
               {activeTab === 'documents' ? 'documents disponibles' : 'opportunités identifiées'}
             </span>
           </p>
        </div>
      </div>
